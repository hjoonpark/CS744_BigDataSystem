...
def parse_neighbors(urls: str) -> Tuple[str, str]:
    parts = re.split(r'\s+', urls)
    return parts[0], parts[1]

def page_rank(input_path, output_path, num_iters):
    ...
    print("  ranks init         : {:.2f} sec".format(t3-t2))
    print("  ranks updated      : {:.2f} sec".format(t4-t3))
    print("  output saved       : {:.2f} sec".format(t5-t4))
    print("===================================================")
...
if __name__ == "__main__":
    ...
    print("  - num_iters   = {}".format(num_iters))
    print("---------------------------------------------------")
    page_rank(input_path, output_path, num_iters)
